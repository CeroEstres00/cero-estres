        ...
        <div className="grid gap-12 justify-center items-center w-full ">
          ...
          <div className="text-center grid place-items-center max-w-full *:max-w-full">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 justify-center lg:justify-start">
              ...
              <a target="_blank" id="heroWhatsappButton" rel="noopener noreferrer" href="https://wa.me/573042675943" className="h-12 w-full inline-flex border rounded-lg justify-center items-center  duration-300 border-white text-white hover:bg-white/10 gap-2 bg-transparent text-lg">
