      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
            Su situación financiera puede mejorar si <span className="text-secondary">actúa a tiempo.</span>
          </h2>
          <p className="text-lg text-white/80 mb-8">
            Cada caso es diferente. Nuestro equipo puede evaluar su situación y explicarle sus opciones legales con claridad.
          </p>
